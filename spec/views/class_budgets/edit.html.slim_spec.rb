...
RSpec.describe "class_budgets/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit class_budget form" do
    render

    assert_select "form[action=?][method=?]", class_budget_path(@class_budget), "post" do
