...
RSpec.describe "food_packs/new", type: :view do
  before(:each) do
    assign(:food_pack, FoodPack.new(
      :g1 => 1,
      :g2 => 1,
      :g3 => 1,
      :g4 => 1,
  ...
  it "renders new food_pack form" do
    render

    assert_select "form[action=?][method=?]", food_packs_path, "post" do
