...
RSpec.describe "req_line_items/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit req_line_item form" do
    render

    assert_select "form[action=?][method=?]", req_line_item_path(@req_line_item), "post" do
