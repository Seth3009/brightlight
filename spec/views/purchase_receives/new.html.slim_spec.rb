...
RSpec.describe "purchase_receives/new", type: :view do
  before(:each) do
    assign(:purchase_receive, PurchaseReceive.new(
      :purchase_order => nil,
      :receiver_id => 1,
      :checker_id => 1,
      :notes => "MyString",
  ...
  it "renders new purchase_receive form" do
    render

    assert_select "form[action=?][method=?]", purchase_receives_path, "post" do
