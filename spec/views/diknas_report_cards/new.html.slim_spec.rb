...
RSpec.describe "diknas_report_cards/new", type: :view do
  before(:each) do
    assign(:diknas_report_card, DiknasReportCard.new(
      :student => nil,
      :grade_level => nil,
      :grade_section => nil,
      :academic_year => nil,
  ...
  it "renders new diknas_report_card form" do
    render

    assert_select "form[action=?][method=?]", diknas_report_cards_path, "post" do
