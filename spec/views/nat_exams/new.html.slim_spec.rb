...
RSpec.describe "nat_exams/new", type: :view do
  before(:each) do
    assign(:nat_exam, NatExam.new(
      :student => nil,
      :grade_level => nil,
      :academic_year => nil,
      :diknas_course => nil,
  ...
  it "renders new nat_exam form" do
    render

    assert_select "form[action=?][method=?]", nat_exams_path, "post" do
