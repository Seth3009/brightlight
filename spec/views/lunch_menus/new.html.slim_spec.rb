...
RSpec.describe "lunch_menus/new", type: :view do
  before(:each) do
    assign(:lunch_menu, LunchMenu.new(
      :food => nil,
      :adj_g1 => 1,
      :adj_g4 => 1,
      :adj_sol => 1,
  ...
  it "renders new lunch_menu form" do
    render

    assert_select "form[action=?][method=?]", lunch_menus_path, "post" do
