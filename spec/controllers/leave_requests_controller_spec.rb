...
RSpec.describe LeaveRequestsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested leave_request as @leave_request" do
      leave_request = LeaveRequest.create! valid_attributes
      get :show, params: {id: leave_request.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested leave_request as @leave_request" do
      leave_request = LeaveRequest.create! valid_attributes
      get :edit, params: {id: leave_request.to_param}, session: valid_session
      expect(assigns(:leave_request)).to eq(leave_request)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new LeaveRequest" do
        expect {
          post :create, params: {leave_request: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved leave_request as @leave_request" do
        post :create, params: {leave_request: invalid_attributes}, session: valid_session
        expect(assigns(:leave_request)).to be_a_new(LeaveRequest)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested leave_request" do
        leave_request = LeaveRequest.create! valid_attributes
        put :update, params: {id: leave_request.to_param, leave_request: new_attributes}, session: valid_session
      ...
      it "assigns the requested leave_request as @leave_request" do
        leave_request = LeaveRequest.create! valid_attributes
        put :update, params: {id: leave_request.to_param, leave_request: valid_attributes}, session: valid_session
        expect(assigns(:leave_request)).to eq(leave_request)
      end
    ...
    context "with invalid params" do
      it "assigns the leave_request as @leave_request" do
        leave_request = LeaveRequest.create! valid_attributes
        put :update, params: {id: leave_request.to_param, leave_request: invalid_attributes}, session: valid_session
        expect(assigns(:leave_request)).to eq(leave_request)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested leave_request" do
      leave_request = LeaveRequest.create! valid_attributes
      expect {
        delete :destroy, params: {id: leave_request.to_param}, session: valid_session
      }.to change(LeaveRequest, :count).by(-1)
    end
