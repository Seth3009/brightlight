class DiknasConversionsController < ApplicationController
  ...
  private
    ...
    def diknas_conversion_params
      params.require(:diknas_conversion).permit(:diknas_course_id, :academic_year_id, :academic_term_id, :weight, :notes, diknas_conversion_items_attributes: [:course_id, :academic_year_id, :academic_term_id, :weight, :notes, :_destroy])
    end
end
