class DeliveryItemsController < ApplicationController
  ...
  private
    ...
    def delivery_item_params
      params.require(:delivery_item).permit(:delivery, :order_item, :quantity, :unit,, :accepted_by, :accepted_date, :checked_by, :checked_date,, :notes,, :is_accepted, :is_rejected, :reject_notes,, :accept_notes)
    end
end
